...
class Article extends ModelEntity
{
    ...
    /**
     * @var boolean $swagIsTrustedShopsArticle
     *
     * @ORM\Column(name="swag_is_trusted_shops_article", type="boolean", nullable=true)
     */
     protected $swagIsTrustedShopsArticle;


    /**
     * @var integer $swagTrustedRange
     *
     * @ORM\Column(name="swag_trusted_range", type="integer", nullable=true)
     */
     protected $swagTrustedRange;


    /**
     * @var string $swagTrustedDuration
     *
     * @ORM\Column(name="swag_trusted_duration", type="string", nullable=true)
     */
     protected $swagTrustedDuration;
    ...
    public function getSwagIsTrustedShopsArticle()
    {
        return $this->swagIsTrustedShopsArticle;
    }

    public function setSwagIsTrustedShopsArticle($swagIsTrustedShopsArticle)
    {
        $this->swagIsTrustedShopsArticle = $swagIsTrustedShopsArticle;
        return $this;
    }
    

    public function getSwagTrustedRange()
    {
        return $this->swagTrustedRange;
    }

    public function setSwagTrustedRange($swagTrustedRange)
    {
        $this->swagTrustedRange = $swagTrustedRange;
        return $this;
    }
    

    public function getSwagTrustedDuration()
    {
        return $this->swagTrustedDuration;
    }

    public function setSwagTrustedDuration($swagTrustedDuration)
    {
        $this->swagTrustedDuration = $swagTrustedDuration;
        return $this;
    }
